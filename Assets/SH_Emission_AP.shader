	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target 
			{
				...
				o.Emission = ( ( _Color0 + _Float0 ) * tex2D( _TextureSample0, uv_TextureSample0 ) ).rgb;
				#if defined(_SPECULAR_SETUP)
...
/*ASEBEGIN
Version=19002
99;115;1126;552;1301.687;584.4565;2.021929;True;True
Node;AmplifyShaderEditor.ColorNode;2;-772.0812,-64.52965;Inherit;False;Property;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0.9245283,0.8564467,0,0;0.9245283,0.8564467,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=19854F5A1B97B52185537D788E0BB2B55F04CD22